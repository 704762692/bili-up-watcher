...
def fetch_polymer(uid, op):
    """官方新动态接口(主源)。带 buvid cookie,412 时换新 cookie 重试一次。"""
    url = ("https://api.bilibili.com/x/polymer/web-dynamic/v1/feed/space"
           "?host_mid=%d&platform=web&timezone_offset=-480&features=itemOpusStyle" % uid)
    ...
    for attempt in (1, 2):
        ...
        try:
            ...
            if e.code == 412 and attempt == 1:
                print("  被风控(412),换新 cookie 重试一次…")
